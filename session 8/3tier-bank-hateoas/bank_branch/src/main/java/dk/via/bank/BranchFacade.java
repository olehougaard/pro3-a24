...
public class BranchFacade implements Branch {
    ...
    protected BranchFacade(BranchCustomerService customerService, BranchAccountService accountService, BranchTransactionService transactionService, BranchExchangeService exchangeService) {
